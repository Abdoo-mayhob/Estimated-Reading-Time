...
class EstReadTime {
	...
	public function meta_box_cb( $post ) {
		...
		?>
		<input type="number" name="<?php echo esc_attr( self::READ_ETA_META_FIELD_NAME ) ?>"
	...
	public function shortcode_widget() {
		...
		<div class="ert" style="display: flex;align-items: center;justify-content: flex-start;gap: 6px;">
			<img width="16" height="16" style="height: 16px; width: 16px;"
				src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . "assets/clock.svg" ) ?>" alt="CLock Icon">
